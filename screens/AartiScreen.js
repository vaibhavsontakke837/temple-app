...
const AARTI_LINES = [
  "विराळ गाव ब्रह्ममुर्ती वर्णा वया दयावे स्फुर्ती",
  ...
  "इच्दा पुरवी दासाचीआरती करू सद्गुरूची धोंडुतात्या महाराजांची आरती ॥१॥",
  "", "",  "",  "",  "",  "",
  ...
  "पुजा करी भास्कराची करू सद्गुरूची धोंडुतात्या महाराजाची आरती ॥२॥",
  "", "",  "",  "",  "",  "",
  "जगामध्ये वागयची वृत्ती भोळा जसा उमापती",
  "कोपला सुर्य कलाती रजतम मदन भस्म होती",
  "मंदार आधीक पुष्प शोभा मदार अधीक पुष्प शोभा",
  "वाद्य झण झणीत मंत्र मुखी म्हणीत",
  "आम्हाला आस ह्या चरणाची आरती करू सद्गुरूची धोंडुतात्या महाराजी आरती ॥३॥",
  "", "",  "",  "",  "",  "",
  ...
  "आम्हाला आसया चरणाची आरती करू सद्गुरूची धोंडुतात्या महाराजाची आरती ॥४॥"
];
...
export default function AartiScreen() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.cream }]}>
      <Text style={[styles.heading, { color: theme.colors.text }]}>{t("aarti")}</Text>
      
      <View style={[styles.card, { backgroundColor: theme.colors.card }]}>
        <Text style={[styles.label, { color: theme.colors.primary }]}>श्री समर्थ सद्गुरू धोंडुतात्या महाराजांची आरती</Text>
